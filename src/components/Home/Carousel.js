        ...
        <div id="header-carousel" className="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div className="carousel-inner">
                <div className="carousel-item active" style={{"minHeight": "300px"}}>
                    <img className="position-relative w-100" src="img/carousel-1.jpg" style={{"minHeight": "300px object-fit: cover"}}/>
                ...
                <div className="carousel-item" style={{"minHeight": "300px"}}>
                    <img className="position-relative w-100" src="img/carousel-2.jpg" style={{"minHeight": "300px object-fit: cover"}}/>
                    <div className="carousel-caption d-flex align-items-center justify-content-center">
                        <div className="p-5" style={{"width": "100%; max-width: 900px"}}>
                            <h5 className="text-white text-uppercase mb-md-3">Best Online Courses</h5>
                ...
                <div className="carousel-item" style={{"minHeight": "300px"}}>
                    <img className="position-relative w-100" src="img/carousel-3.jpg" style={{"minHeight": "300px object-fit: cover"}}/>
                    <div className="carousel-caption d-flex align-items-center justify-content-center">
                        <div className="p-5" style={{"width": "100%; max-width: 900px"}}>
                            <h5 className="text-white text-uppercase mb-md-3">Best Online Courses</h5>
